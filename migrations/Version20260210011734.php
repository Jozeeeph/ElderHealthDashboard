 ...
 */
<<<<<<<< HEAD:migrations/Version20260210011734.php
final class Version20260210011734 extends AbstractMigration
========
final class Version20260209232412 extends AbstractMigration
>>>>>>>> daac3e69f2e266c7acb76da4edec0a8d74af3262:migrations/Version20260209232412.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, date DATETIME NOT NULL, status VARCHAR(30) NOT NULL, post_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_67F068BC4B89032C (post_id), INDEX IDX_67F068BCFB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
